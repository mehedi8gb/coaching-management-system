...
class sm_setup_adminsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataArr = [
            ...
            [12, 2, 'ADA grievance', 'ADA grievance'],
            [13, 2, 'Academic Misconduct', 'A student should be informed of any academic misconduct allegation by their instructor.'],
            [14, 2, 'Sexual Assault', 'Sexual harassment is a serious problem for students at all educational levels.'],
            [15, 2, 'Interpersonal Violence', 'Domestic and Interpersonal Violence'],
            [16, 2, 'Sexual Harassment', 'Sexual Harassment, and Other Discrimination'],
            [17, 2, 'Student conduct', 'A student may only appeal a capricious grade, or student conduct expulsion or suspension.'],
