                ...
                $.each(data, function (i, item) {
                    if (item.length) {
                        ...
                        $.each(item, function (i, classA) {
                            ...
                            $("#select_class_div ul").append("<li data-value='" + classA.id + "' class='option'>" + classA.class_name + "</li>");
                        });
                    } else {
            ...
            success: function (data) {
                ...
                if (data.exams.length) {
                    ...
                    $.each(data.exams, function (i, exam) {
                            ...
                            $("#select_exam_div ul").append("<li data-value='" + exam.id + "' class='option'>" + exam.title + "</li>");
                        });
                    } else {
