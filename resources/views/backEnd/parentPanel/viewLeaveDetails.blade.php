...
{{$leaveDetails->apply_date != ""? App\SmGeneralSettings::DateConvater($leaveDetails->apply_date):''}}
            ...
            <div class="single-meta mt-40">
                <div class="row">
                    <div class="col-lg-2 col-md-5">
                        <div class="value text-left">
                            @lang('lang.leave') @lang('lang.status')
                        </div>
                    </div>
                                ...
                                <div class="d-flex radio-btn-flex flex-column">
                                    <div class="">
                                        ...
                                        @if($leaveDetails->approve_status == 'P')
                                            <button class="primary-btn small tr-bg">@lang('lang.pending')</button>
                                        @endif
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <button class="primary-btn fix-gr-bg">
                            ...
                            @lang('lang.save') @lang('lang.leave') @lang('lang.status')
                        </button>
                    </div>
        ...
        <div class="col-md-4">
                ...
                <div class="student-meta-box">
                        @if ($leaveDetails->role_id == 2)
                           <h5 class="mt-20 mb-20">@lang('lang.user') @lang('lang.details')</h5>
                        @else
                    ...
                    <div class="white-box-modal radius-t-y-0">
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">  
                                    @if ($leaveDetails->role_id == 2)
                                       {{$leaveDetails->student->created_at != ""? App\SmGeneralSettings::DateConvater($leaveDetails->student->created_at):''}}
                                    @else
