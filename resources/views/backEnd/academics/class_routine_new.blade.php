    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6 pull-right">
                <a href="{{url('class-routine/print', [$class_id, $section_id])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('lang.print')</a>                
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-lg-6 text-right">
                                    <a href="{{url('add-new-routine', [$class_time->id, $sm_weekend->id, $class_id, $section_id])}}" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="@lang('lang.create_class_routine')">
