    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('class_routine')}}">@lang('lang.class_routine')</a>
                <a href="{{route('class_routine_create')}}">@lang('lang.class_routine_create')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th width="10%">@lang('lang.days')</th>
                            <th width="30%">@lang('lang.start_time')</th>
                            <th width="30%">@lang('lang.end_time')</th>
                            <th width="30%">@lang('lang.room_number')</th>
                        </tr>
                    </thead>
