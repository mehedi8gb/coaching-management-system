    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{url('expense-head')}}">@lang('lang.expense_head')</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12 text-center">
                                        <button class="primary-btn fix-gr-bg">
                                            ...
                                            {{!isset($expense_head)? "save":"update"}} @lang('lang.expense_head')
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.expense_head') @lang('lang.list')</h3>
                        </div>
                    </div>
                </div>
