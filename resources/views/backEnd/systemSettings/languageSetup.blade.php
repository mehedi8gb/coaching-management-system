...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.language') @lang('lang.settings')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">Dashboard</a>
                <a href="#">@lang('lang.system') @lang('lang.settings')</a>
                <a href="#">@lang('lang.language') @lang('lang.settings')</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-3 mb-30">
                        <div class="white-box onchangeSearch">
                            <select class="w-100 bb niceSelect form-control {{ $errors->has('module_id') ? ' is-invalid' : '' }}" id="module_id" name="module_id">
                                <option data-display="Select Module *" value="">@lang('lang.select') @lang('lang.module') *</option>
