        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="main-title">
                    <h3>@lang('lang.user') @lang('lang.setup')</h3>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="gender">
                                        <option value="">@lang('lang.select') @lang('lang.gender')</option>
                                        <option value="1">@lang('lang.male')</option>
                                        <option value="2">@lang('lang.female')</option>
                                        <option value="3">@lang('lang.others')</option>
                                    </select>
