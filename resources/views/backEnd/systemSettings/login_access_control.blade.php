                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{@$student->user_id}}">
                                        ...
                                        <td>{{@$student->first_name.' '.@$student->last_name}}  {{@$student->user_id}}</td> 
                                        ...
                                        <td>
                                            <label class="switch">
                                              <input type="checkbox" id="ch{{@$student->user_id}}" onclick="lol({{@$student->user_id}},{{@$role}})" class="switch-input" {{@$student->user->access_status == 0? '':'checked'}}>
