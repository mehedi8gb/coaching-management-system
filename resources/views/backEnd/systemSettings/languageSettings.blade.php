    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            @if(isset($edit_languages))
                @if(in_array(452, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                    <div class="row">
                                ...
                                @foreach($sms_languages as $sms_language)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                @if(in_array(453, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                <a href="{{URL::to('/change-language/'.@$sms_language->id)}}"
                                                    class="{{@$sms_language->active_status==1?@$active:@$inactive}} "   > <span
                                            ...
                                            @if(in_array(454, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                            <a href="{{url('/')}}/language-setup/{{@$sms_language->language_universal}} "
                                              ...
                                              @if(in_array(455, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                    <a 
                                                   href="{{url('/')}}/language-delete" class="primary-btn small tr-bg white_space" data-toggle="modal"
