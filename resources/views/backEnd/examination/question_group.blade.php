...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        @if(isset($group))
        @if(in_array(231, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )

        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="{{url('question-group')}}" class="primary-btn small fix-gr-bg">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($group))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'question-group/'.$group->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                        @if(in_array(231, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )

                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'question-group',
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               @if(in_array(232, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )

                                               <a class="dropdown-item" href="{{url('question-group', [$group->id
                                                    ])}}">@lang('lang.edit')</a>
                                               @endif
                                               @if(in_array(233, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['url' => 'question-group/'.$group->id, 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
