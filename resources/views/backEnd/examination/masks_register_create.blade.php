                    ...
                    <tbody>                        
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    <input class="primary-input marks_input" type="text" name="marks[{{$student->id}}][{{$part->id}}]" value="{{!empty($search_mark)?$search_mark:0}}" {{@$absent_check->attendance_type == 'A'? 'readonly':''}}>
                            ...
                            <td>
                                <div class="input-effect mt-10">
                                <input class="primary-input" type="text" name="teacher_remarks[{{$student->id}}][{{$part->subject_id}}]" value="{{$teacher_remarks}}">
