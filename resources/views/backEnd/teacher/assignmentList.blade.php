                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                     ...
                                     @if(in_array(95, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                        ...
                                        @if(@$value->upload_file != "")
                                         @if(in_array(94, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">@lang('lang.delete') @lang('lang.assignment')</h4>
