...
<div class="container-fluid p-0">
    ...
    @if(@in_array(41, App\GlobalVariable::GlobarModuleLinks()))
        <div class="row">
    ...
    <div class="col-lg-3">
        <div class="row">
            <div class="col-lg-12">
                ...
                @if(isset($apply_leave))
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'student-leave-update/'.$apply_leave->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                @else
                    @if(@in_array(41, App\GlobalVariable::GlobarModuleLinks()))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'student-leave-store','method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                    @endif
                @endif
                <div class="white-box">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @if(in_array(93, App\GlobalVariable::GlobarModuleLinks()))
                                        ...
                                        @endif
                                        @if($apply_leave->approve_status == 'P')
                                        @if(in_array(42, App\GlobalVariable::GlobarModuleLinks()))

                                        <a class="dropdown-item" href="{{url('student-leave-edit', [$apply_leave->id
                                            ])}}">@lang('lang.edit')</a> 

                                        @endif
                                        @if(in_array(94, App\GlobalVariable::GlobarModuleLinks()))
