    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{url('student-online-exam')}}">@lang('lang.online_exam')</a>
                <a href="{{url('take-online-exam/'.@$online_exam->id)}}">@lang('lang.take_online_exam')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('lang.take_online_exam')</h3>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr align="center" class="exam-bg">
                                        <td colspan="2" class="pt-4 pb-3 px-sm-5">
                                            <h1>@lang('lang.exam_name') : {{@$online_exam->title}}</h1>
                                            <h2><b>@lang('lang.subject') : </b>{{@$online_exam->subject !=""?@$online_exam->subject->subject_name:""}}</h2>
                                            <h6><b>@lang('lang.class_Sec') : </b>{{@$online_exam->class !=""?@$online_exam->class->class_name:""}} ({{@$online_exam->section !=""?@$online_exam->section->section_name:""}})</h6>
                                            <h3 class="mb-20"><b>@lang('lang.total_marks') : </b>
                                            @php
                                            @$total_marks = 0;
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p><b>@lang('lang.instruction') : </b>{{@$online_exam->instruction}}</p>
                                                </div>
                                                <div class="col-md-6">
                                                    <p class="mb-2"><strong>@lang('lang.exam_has_to_be_submitted_within'): </strong>{{@$online_exam->date}} {{@$online_exam->end_time}}</p>
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-center pt-4">
                                            <button class="primary-btn fix-gr-bg" id="online_take_exam_button" type="">
                                                ...
                                                @lang('lang.submit') @lang('lang.exam')
                                            </button>
                                        </td>
                                    </tr>
                                </tbody>
