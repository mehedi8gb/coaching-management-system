                ...
                <div class="id_card" id="id_card" style="display: grid !important;grid-template-columns: repeat(3,1fr) !important;grid-gap: 20px;justify-content: center;">
                    @foreach($students as $student)
    			     <table cellpadding="0" cellspacing="0" border="0" width="156" height="241" align="center" style=" border: 1px solid #ddd; margin: 0px 0 0 0;" >
                        <tr style="border-right: 1px solid #ddd; border-left: 1px solid #ddd;  height: 0px; ">
                            <td colspan="3" style=" position: relative; text-align: center; background-color: #c738d8; border:1px solid #c738d8">
                               <!--  <center>
                                ...
                                <h3 style="padding: 5px; text-align: center; margin-bottom: 0px; font-size: 12px;  color: #fff; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; ">@lang('lang.view') @lang('lang.student_id_card')</h3>
                            </td>
                        </tr>
                        <tr >
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.name')</td>
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.admission_no')</td>
                        ...
                        @if(@$id_card->class == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd;">@lang('lang.class')</td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.father_name')</td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.mother_name')</td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.student') @lang('lang.address')</td>                           
                        ...
                        @if(@$id_card->blood == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.blood_group')</td>                           
                        ...
                        @if(@$id_card->phone == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.phone')</td>
                        ...
                        @if(@$id_card->dob == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('lang.date_of_birth')</td>                            
                            <td style=" border-right: 1px solid #ddd; text-align: right; margin-right: 40px !important;">                              
                                {{-- {{@$student->date_of_birth}} --}}
                                {{@$student->date_of_birth != ""? App\SmGeneralSettings::DateConvater(@$student->birth_of_birth):''}}
                            </td>
                        </tr>
                        @endif
                        <tr >
