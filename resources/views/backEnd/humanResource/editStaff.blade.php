                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control" name="marital_status">
                                            ...
                                            <option value="married" {{$editData->marital_status == "married"? 'selected':''}}>@lang('lang.married')</option>
                                            <option value="unmarried" {{$editData->marital_status == "unmarried"? 'selected':''}}>@lang('lang.unmarried')</option>
...
<div class="row mt-40">
    <div class="col-lg-12 text-center">
            @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" > @lang('lang.update_staff')</button></span>
        @else
