                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="input-effect mt-25">
                                    ...
                                    type="text" onkeypress="return isNumberKey(event)" name="total_days" autocomplete="off" value="{{isset($leave_type)? $leave_type->total_days:Request::old('total_days')}}" min="0">
