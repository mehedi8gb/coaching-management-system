                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    if($fees_assigned->feesGroupMaster->fees_group_id != 1 && $fees_assigned->feesGroupMaster->fees_group_id != 2){
                                        echo number_format($fees_assigned->feesGroupMaster->amount+$total_fine, 2, '.', '');
                                        // echo '###'.$fees_assigned->feesGroupMaster->amount;
                                    }else{
                                        if($fees_assigned->feesGroupMaster->fees_group_id == 1){
                                            echo number_format($student->route->far+$total_fine, 2, '.', '');
                                           
                                        }else{
                                            echo number_format($student->room->cost_per_bed+$total_fine, 2, '.', '');
                                        }
                                    }
                            ...
                            <td>
                                @php 
                                    ...
                                    echo  number_format($rest_amount+$total_fine, 2, '.', '');
                                @endphp
                            </td>
                            <td>
                                <div class="dropdown">
