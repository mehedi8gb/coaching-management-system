    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{url('student-fees')}}">@lang('lang.all_fees')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.collect_fees') @lang('lang.online')</h3>
                </div>
            </div>
        </div>
                     ...
                     <div class="row justify-content-center mb-30">
                        <div class="col-lg-4">
                            <div class="input-effect">
                                ...
                                <label>@lang('lang.fees') @lang('lang.amount') <span>*</span> </label>
