...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.issue_item')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.inventory')</a>
                <a href="{{url('issue-new-item')}}">@lang('lang.issue_item')</a>
          </div>
        </div>
    </div>
</section>
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-3">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('member_type') ? ' is-invalid' : '' }}" name="member_type" id="member_type">
                                            <option data-display="Member Type *" value="">@lang('lang.member_type') *</option>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" name="subject" id="subject">
                                        <option data-display="Select Subject *" value="">@lang('lang.select')</option>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('lang.book') @lang('lang.none')</label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('lang.isbn') @lang('lang.none')</label>
                                    <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('lang.rack') @lang('lang.number') <span>*</span> </label>
                                    <span class="focus-border"></span>
