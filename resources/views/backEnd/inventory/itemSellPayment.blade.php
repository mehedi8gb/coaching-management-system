...
<div class="container-fluid">
   {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'save-item-sell-payment',
        ...
        <div class="row mt-25">
            ...
            <div class="col-lg-6" id="">
                <div class="input-effect">
                    ...
                    <label>@lang('lang.payment') @lang('lang.date') </label>
                    <span class="focus-border"></span>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="input-effect">
                    ...
                    <select class="niceSelect w-100 bb form-control{{ $errors->has('payment_mode') ? ' is-invalid' : '' }}" name="payment_method" id="payment_mode">
                        <option data-display="Payment Method *" value="">@lang('lang.payment_method') *</option>
