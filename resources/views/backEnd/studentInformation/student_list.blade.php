                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <select class="niceSelect w-100 bb">
                                        <option data-display="Select Class">@lang('lang.select_class')</option>
                                        <option value="1">@lang('lang.Class')Class 1</option>
                                        <option value="2">@lang('lang.Class')Class 2</option>
                                    </select>
                                </div>
