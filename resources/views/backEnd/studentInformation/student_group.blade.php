    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="{{url('student-group')}}" class="primary-btn small fix-gr-bg">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                @if(in_array(79, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                <a class="dropdown-item" href="{{route('student_group_edit', [$student_group->id])}}">@lang('lang.edit')</a>
                                               @endif
                                               @if(in_array(80, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
