                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                @if(in_array(505, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                ...
                                                @endif
                                                @if(in_array(507, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                <a class="dropdown-item" href="{{url('edit-testimonial/'.@$value->id)}}">@lang('lang.edit')</a>
                                                @endif
                                                @if(in_array(508, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
