        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="justify-content-center">
                    ...
                    <form method="POST" action="{{url('module-verify-purchase')}}" class="mt-40">
                        @csrf
                        {{csrf_field()}}
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control " name="name"  required="required"  placeholder="Enter Your Envato User Name" value="{{@$name}}}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="installationdomain" required="required"  placeholder="Enter Your Installation Domain" value="{{url('/')}}">
                        </div>
