                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>The Ultimate Education Management System for School, College, Institute & Academy </h1>
                            ...
                            <a  class="btn_1" target="_blank" href="https://www.youtube.com/channel/UCwCDI8YDQiDdt1H0iNRPgpw"> <i class="ti-control-play"></i> 
                                <!-- <a id="play-video_1" class="btn_1 popup-youtube" target="_blank" href="https://www.youtube.com/channel/UCwCDI8YDQiDdt1H0iNRPgpw"> <i class="ti-control-play"></i> --> 
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="btn_1 d-none d-lg-block" target="_blank" href="https://codecanyon.net/item/infix-school-academic-management-system/23876323">Purchase</a>
                    </nav>
                </div>
            </div>
        </div>
                    ...
                    <a class="support-link" href="mailto:support@pixelcoder.net"> 
                        <div class="single_feature">
                            <div class="single_feature_part">
                                ...
                                <p class="custome-button">Submit a Ticket </p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p class="custome-button">Live Chat</p></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <a class="support-link" target="_blank" href="{{url('/docs')}}">
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><i class="ti-write"></i></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <a href="https://codecanyon.net/item/infix-school-academic-management-system/23876323" class="footer_btn"> <i class="ti-shopping-cart-full"></i>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text">
                        <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019 infix - Ultimate Education ERP. All Rights
