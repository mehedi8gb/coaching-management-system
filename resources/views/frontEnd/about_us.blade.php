                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor {{isset($update)? '':'isDisabled'}}">
                                    ...
                                    <div class="row no-gutters input-right-icon mt-35">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('main_image') ? ' is-invalid' : '' }}" id="placeholderInputMainFile" type="text"
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="browseFileMailFile">@lang('lang.browse')</label>
                        ...
                        <div class="col-lg-12 scroll_table">
                            ...
                            <table class="display school-table school-table-style" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        @if($about_us != "")
                                            @if(in_array(521, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                <a class="primary-btn small fix-gr-bg" data-toggle="modal" data-target="#showimageModal"  href="#">view</a>
                                            @endif
                                            @if(in_array(522, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
