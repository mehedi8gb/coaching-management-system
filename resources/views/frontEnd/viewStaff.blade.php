            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        ...
                        <a class="primary-btn icon-only fix-gr-bg modalLink" title="Delete Document" data-modal-size="modal-md"  href="{{url('delete-staff-document-view/'.$value->id)}}">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input class="primary-input form-control" type="text" name="title" id="title">
                        ...
                        <div class="single-activity">
                            ...
                            <div class="sub-activity-box d-flex">
                                <h6 class="time text-uppercase">                                                                            
                                     {{$timeline->created_at != ""? App\SmGeneralSettings::DateConvater($timeline->created_at):''}}
                                </h6>
