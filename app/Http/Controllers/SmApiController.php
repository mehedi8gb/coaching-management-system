...
class SmApiController extends Controller
{
            ...
            foreach ($lastest_data as $device_log) {
                ...
                if ($user_table) {
                    if ($user_table->role_id == 2) {
                        ...
                        $attendance = SmStudentAttendance::where('student_id', $sm_students->id)->where('attendance_date', date('Y-m-d', strtotime($device_log->checktime)))->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->first();
                        if ($attendance == "") {
            ...
            foreach ($students as $student) {
                ...
                if ($attendance != "") {
                    ...
                    try {
                        ...
                        // dd($e);
                        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                            return ApiBaseMethod::sendError(null, 'Something Wrong');
                        }
                    }
    ...
    public function NewExamSchedule(Request $request)
    {
        ...
        if ($request->assigned_id == "") {
            $check_date = SmExamSchedule::where('class_id', $request->class_id)->where('section_id', $request->section_id)->where('exam_term_id', $request->exam_term_id)->where('date', date('Y-m-d', strtotime($request->date)))->where('exam_period_id', $request->exam_period_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        } else {
            $check_date = SmExamSchedule::where('id', '!=', $request->assigned_id)->where('class_id', $request->class_id)->where('section_id', $request->section_id)->where('exam_term_id', $request->exam_term_id)->where('date', date('Y-m-d', strtotime($request->date)))->where('exam_period_id', $request->exam_period_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        }
    ...
    public function saas_NewExamSchedule(Request $request, $school_id)
    {
        ...
        if ($request->assigned_id == "") {
            $check_date = SmExamSchedule::where('class_id', $request->class_id)->where('section_id', $request->section_id)->where('exam_term_id', $request->exam_term_id)->where('date', date('Y-m-d', strtotime($request->date)))->where('exam_period_id', $request->exam_period_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        } else {
            $check_date = SmExamSchedule::where('id', '!=', $request->assigned_id)->where('class_id', $request->class_id)->where('section_id', $request->section_id)->where('exam_term_id', $request->exam_term_id)->where('date', date('Y-m-d', strtotime($request->date)))->where('exam_period_id', $request->exam_period_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        }
    ...
    public function postal_dispatch_show(Request $request, $id)
    {
        ...
        try {
            $postal_dispatchs = SmPostalDispatch::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_postal_dispatch_show(Request $request,$school_id, $id)
    {
        ...
        try {
            $postal_dispatchs = SmPostalDispatch::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    {
        try {
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            $student_list = DB::table('sm_students')
                ->join('sm_classes', 'sm_students.class_id', '=', 'sm_classes.id')
                ->join('sm_sections', 'sm_students.section_id', '=', 'sm_sections.id')
                ->where('sm_students.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')
    ...
    public function saas_studentView(Request $request,$school_id, $id)
    {
        try {
            ...
            // return $vehicle;
            $fees_assigneds = SmFeesAssign::where('student_id', $id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            //  return $fees_assigneds;
            $fees_discounts = SmFeesAssignDiscount::where('student_id', $id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            // $documents = SmStudentDocument::where('student_staff_id', $id)->where('type', 'stu')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $documents = SmStudentDocument::where('student_staff_id', $id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();

            $timelines = SmStudentTimeline::where('staff_student_id', $id)->where('type', 'stu')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function saas_studentEdit(Request $request,$school_id, $id)
    {
        try {
            ...
            $classes = SmClass::where('active_status', '=', '1')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            $sections = SmSection::where('active_status', '=', '1')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function studentSearch(Request $request)
    {
        ...
        try {
            ...
            $attendance_type = "";
            foreach ($students as $student) {
                $attendance = SmStudentAttendance::where('student_id', $student->id)->where('attendance_date', date('Y-m-d', strtotime($request->attendance_date)))->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->first();
    ...
    public function studentAttendanceStore(Request $request)
    {
        ...
        try {
            foreach ($request->id as $student) {
                $attendance = SmStudentAttendance::where('student_id', $student)->where('attendance_date', date('Y-m-d', strtotime($request->date)))->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->first();
    ...
    public function saas_studentAttendanceReport(Request $request,$school_id)
    {
        try {
            ...
            $genders = SmBaseSetup::where('active_status', '=', '1')->where('base_group_id', '=', '1')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function saas_studentAttendanceReportSearch(Request $request, $school_id)
    {
        ...
        try {
            ...
            $days = cal_days_in_month(CAL_GREGORIAN, $request->month, $request->year);
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            $students = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();

            $attendances = [];
            foreach ($students as $student) {
                $attendance = SmStudentAttendance::where('student_id', $student->id)->where('attendance_date', 'like', $request->year . '-' . $request->month . '%')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
                if (count($attendance) != 0) {
                    $attendances[] = $attendance;
                }
            }
    ...
    public function student_group_index(Request $request)
    {
        ...
        try {
            $student_groups = SmStudentGroup::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_student_group_index(Request $request, $school_id)
    {
        ...
        try {
            $student_groups = SmStudentGroup::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        ...
        try {
            if ($request->result == 'P') {
                ...
                if (@$students == 0) {
                    ...
                    $students['students'] = [];
                foreach ($students['allresult_data'] as $key => $value) {
                    $d = SmStudent::where('id', $value->student_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)-first();
                ...
                $students = SmStudent::where('class_id', '=', $request->current_class)->where('session_id', '=', $request->current_session)->where('section_id', $request->section)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            }
            $current_session = $request->current_session;
            $current_class = $request->current_class;
            $sessions = SmAcademicYear::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)-get();
    ...
    {
        try {
            $students = SmStudent::where('active_status', 0)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function saas_disabledStudentSearch(Request $request, $school_id)
    {
        try {
            $students = SmStudent::query();
            $students->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('active_status', 0)->where('school_id',$school_id);
            if ($request->class != "") {
                $students->where('class_id', $request->class);
            }
            if ($request->section != "") {
            ...
            $students = $students->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function uploadContentList(Request $request)
    {
        ...
        try {
            $contentTypes = SmContentType::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();

            if (Auth()->user()->id == 1 || Auth()->user()->id == 5) {
                $uploadContents = SmTeacherUploadContent::where('available_for_admin', 1)->orWhere('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            } else {
                $uploadContents = SmTeacherUploadContent::Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
    ...
    public function saas_uploadContentList(Request $request, $school_id)
    {
        ...
        try {
            $contentTypes = SmContentType::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();

            if (Auth()->user()->id == 1 || Auth()->user()->id == 5) {
                $uploadContents = SmTeacherUploadContent::where('available_for_admin', 1)->orWhere('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            } else {
                $uploadContents = SmTeacherUploadContent::Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            }
            ...
            foreach ($request->available_for as $value) {
                ...
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
                    ...
                    foreach ($roles as $role) {
                        $staffs = SmStaff::where('role_id', $role->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                ...
                if ($value == 'student') {
                    if (isset($request->all_classes)) {
                        $students = SmStudent::select('id', 'user_id')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                        foreach ($students as $student) {
                            $notification = new SmNotification;
                        ...
                        $students = SmStudent::select('id')->where('class_id', $request->class)->where('section_id', $request->section)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                        foreach ($students as $student) {
                            $notification = new SmNotification;
                            $notification->user_id = $student->id;
                            $notification->role_id = 2;
    ...
    public function assignmentList(Request $request)
    {
        ...
        try {
            ...
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'as')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'as')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
    ...
    public function studyMetarialList(Request $request)
    {
        ...
        try {
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'st')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'st')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
    ...
    public function saas_studyMetarialList(Request $request , $school_id)
    {
        ...
        try {
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'st')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'st')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            }
    ...
    public function syllabusList(Request $request)
    {
        try {
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'sy')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'sy')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
    ...
    public function saas_syllabusList(Request $request, $school_id)
    {
        try {
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'sy')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'sy')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            }
    ...
    public function otherDownloadList(Request $request)
    {
        ...
        try {
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'ot')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'ot')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
    ...
    public function saas_otherDownloadList(Request $request, $school_id)
    {
        ...
        try {
            if (Auth()->user()->id == 1) {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'ot')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            } else {
                $uploadContents = SmTeacherUploadContent::where('content_type', 'ot')->Where('created_by', Auth::user()->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            }
    ...
    public function feesDiscountAssignSearch(Request $request)
    {
        ...
        try {
            ...
            // $fees_assign_groups = SmFeesMaster::where('fees_group_id', $request->fees_group_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function subject_edit(Request $request, $id)
    {
        ...
        try {
            ...
            $subjects = SmSubject::where('active_status', 1)->orderBy('id', 'DESC')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_subject_edit(Request $request,$school_id, $id)
    {
        ...
        try {
            ...
            $subjects = SmSubject::where('active_status', 1)->orderBy('id', 'DESC')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    {
        try {
            $sections = SmSection::where('active_status', '=', 1)->where('created_at', 'LIKE', '%' . $this->date . '%')->get();
            $classes = SmClass::where('created_at', 'LIKE', '%' . $this->date . '%')->where('active_status', '=', 1)->where('created_at', 'LIKE', '%' . $this->date . '%')->get();
    ...
    {
        try {
            $sections = SmSection::where('active_status', '=', 1)->where('created_at', 'LIKE', '%' . $this->date . '%')->where('school_id',$school_id)->get();
            $classes = SmClass::where('created_at', 'LIKE', '%' . $this->date . '%')->where('active_status', '=', 1)->where('created_at', 'LIKE', '%' . $this->date . '%')->where('school_id',$school_id)->get();
    ...
    public function class_edit(Request $request, $id)
    {
        ...
        try {
            ...
            $classes = SmClass::where('active_status', '=', 1)->orderBy('id', 'desc')->where('created_at', 'LIKE', '%' . $this->date . '%')->get();
    ...
    public function saas_class_edit(Request $request,$school_id, $id)
    {
        ...
        try {
            ...
            $sectionByNames = SmClassSection::select('section_id')->where('class_id', '=', $classById->id)->where('created_at', 'LIKE', '%' . $this->date . '%')->where('school_id',$school_id)->get();
            ...
            $classes = SmClass::where('active_status', '=', 1)->orderBy('id', 'desc')->where('created_at', 'LIKE', '%' . $this->date . '%')->where('school_id',$school_id)->get();
    ...
    public function Section_edit(Request $request, $id)
    {
        ...
        try {
            ...
            $sections = SmSection::where('active_status', '=', 1)->orderBy('id', 'desc')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_Section_edit(Request $request,$school_id, $id)
    {
        ...
        try {
            ...
            $sections = SmSection::where('active_status', '=', 1)->orderBy('id', 'desc')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function class_Routine(Request $request, $id = null)
    {
        ...
        $class_times = SmClassTime::where('type', 'class')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            foreach ($weekenD as $row) {
                $data[$row->name] = DB::table('sm_class_routine_updates')
                    ...
                    ])->where('sm_class_routine_updates.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
        ...
        public function saas_class_Routine(Request $request,$school_id, $id = null)
    {
        ...
        $sm_weekends = SmWeekend::orderBy('order', 'ASC')->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        $class_times = SmClassTime::where('type', 'class')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            foreach ($weekenD as $row) {
                $data[$row->name] = DB::table('sm_class_routine_updates')
                    ...
                    ->where([
                        ['sm_class_routine_updates.class_id', $class_id], ['sm_class_routine_updates.section_id', $section_id], ['sm_class_routine_updates.day', $row->id],
                    ])->where('sm_class_routine_updates.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')
    ...
    public function homeworkList(Request $request)
    {
        ...
        try {
            set_time_limit(900);
            $homeworkLists = SmHomework::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $classes = SmClass::where('active_status', '=', '1')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_homeworkList(Request $request,$school_id)
    {
        ...
        try {
            set_time_limit(900);
            $homeworkLists = SmHomework::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            $classes = SmClass::where('active_status', '=', '1')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function searchHomework(Request $request)
    {
        ...
        try {
            ...
            $homeworkLists = $homeworkLists->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_searchHomework(Request $request, $school_id)
    {
        ...
        try {
            ...
            $homeworkLists = $homeworkLists->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function saas_sendEmailSmsView(Request $request, $school_id)
    {
        try {
            ...
            $classes = SmClass::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
    ...
    public function studentDormitoryReportSearch(Request $request)
    {
        ...
        try {
            ...
            $students = $students->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')
                ->get();
    ...
    public function examRoutineReportSearch(Request $request)
    {
        ...
        try {
            $exam_types = SmExamType::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $exam_periods = SmClassTime::where('type', 'exam')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $exam_routines = SmExamSchedule::where('exam_term_id', $request->exam)->orderBy('date', 'ASC')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function meritListReportSearch(Request $request)
    {
        try {
            ...
            if ($request->method() == 'POST') {
                ...
                $allresult_data = SmTemporaryMeritlist::orderBy('merit_order', 'asc')->where('exam_id', '=', $InputClassId)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function onlineExamReport(Request $request)
    {
        ...
        try {
            $exams = SmOnlineExam::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function onlineExamReportSearch(Request $request)
    {
        ...
        try {
            ...
            $students = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function markSheetReportStudentSearch(Request $request)
    {
        ...
        try {
            $exams = SmExamType::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $classes        =   SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $exam_types     =   SmExamType::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();

            $subjects = SmAssignSubject::where([['class_id', $request->class], ['section_id', $request->section]])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            ...
            $is_result_available = SmResultStore::where([['class_id', $request->class], ['exam_type_id', $request->exam], ['section_id', $request->section], ['student_id', $request->student]])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            ...
            $subjects = SmAssignSubject::where('class_id', $request->class)->where('section_id', $request->section)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $exams = SmExamType::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $grades = SmMarksGrade::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function tabulationSheetReportSearch(Request $request)
    {
        ...
        try {
            ...
            if ($request->student == "") {
                $eligible_subjects       = SmAssignSubject::where('class_id', $class_id)->where('section_id', $section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                $eligible_students       = SmStudent::where('class_id', $class_id)->where('section_id', $section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                foreach ($eligible_students as $SingleStudent) {
                    foreach ($eligible_subjects as $subject) {
    ...
    {
        try {
            $exams = SmExam::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function progressCardReportSearch(Request $request)
    {
        ...
        try {
            $exams = SmExam::where('active_status', 1)->where('class_id', $request->class)->where('section_id', $request->section)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function studentHomework(Request $request, $id = null)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $subject_list = SmAssignSubject::where([['class_id', $class_id], ['section_id', $student_detail->section_id]])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            ...
            foreach ($subject_list as $subject) {
                ...
                $allList[$subject->subject->subject_name] = DB::table('sm_homeworks')
                    ...
                    ->where('subject_id', $subject->subject_id)->where('sm_homeworks.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get()->toArray();;
            }
    ...
    public function saas_studentHomework(Request $request,$school_id, $id = null)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $class_id = @$student_detail->class->id;
            $subject_list = SmAssignSubject::where([['class_id', $class_id], ['section_id', @$student_detail->section_id]])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
            ...
            foreach ($subject_list as $subject) {
                ...
                $allList[$subject->subject->subject_name] = DB::table('sm_homeworks')
                    ->leftjoin('sm_subjects', 'sm_subjects.id', '=', 'sm_homeworks.subject_id')
                    ->where('class_id', @$student_detail->class_id)->where('section_id', @$student_detail->section_id)
                    ->where('subject_id', $subject->subject_id)->where('sm_homeworks.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('sm_homeworks.school_id',$school_id)->get()->toArray();;
            }
            foreach ($allList as $single) {
                foreach ($single as $singleHw) {
                    $std_homework = DB::table('sm_homework_students')
            ...
            $homeworkLists = SmHomework::where('class_id', @$student_detail->class_id)->where('section_id', @$student_detail->section_id)
                ->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        } else {
            $user = Auth::user();
    ...
    public function studentDashboard(Request $request, $id = null)
    {
        ...
        $driver = SmVehicle::where('sm_vehicles.id', '=', $student_detail->vechile_id)
            ...
            ->first();
        $siblings = SmStudent::where('parent_id', $student_detail->parent_id)->get();
        $fees_assigneds = SmFeesAssign::where('student_id', $student_detail->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        $fees_discounts = SmFeesAssignDiscount::where('student_id', $student_detail->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        $documents = SmStudentDocument::where('student_staff_id', $student_detail->id)->where('type', 'stu')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        $timelines = SmStudentTimeline::where('staff_student_id', $student_detail->id)->where('type', 'stu')->where('visible_to_student', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        $exams = SmExamSchedule::where('class_id', $student_detail->class_id)->where('section_id', $student_detail->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        $grades = SmMarksGrade::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_studentDashboard(Request $request,$school_id, $id = null)
    {
        ...
        $driver = SmVehicle::where('sm_vehicles.id', '=', @$student_detail->vechile_id)
            ...
            ->first();
        $siblings = SmStudent::where('parent_id', @$student_detail->parent_id)->where('school_id',$school_id)->get();
        $fees_assigneds = SmFeesAssign::where('student_id', @$student_detail->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        $fees_discounts = SmFeesAssignDiscount::where('student_id', @$student_detail->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        $documents = SmStudentDocument::where('student_staff_id', @$student_detail->id)->where('type', 'stu')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        $timelines = SmStudentTimeline::where('staff_student_id', @$student_detail->id)->where('type', 'stu')->where('visible_to_student', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        $exams = SmExamSchedule::where('class_id', @$student_detail->class_id)->where('section_id', @$student_detail->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('school_id',$school_id)->get();
        $grades = SmMarksGrade::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function studentSubjectApi(Request $request, $id)
    {
        ...
        $assignSubjects = DB::table('sm_assign_subjects')
            ...
            ->where('sm_assign_subjects.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $data = [];
    ...
    public function saas_studentSubjectApi(Request $request,$school_id, $id)
    {
        ...
        $assignSubjects = DB::table('sm_assign_subjects')
            ...
            ->where('sm_assign_subjects.class_id', '=', @$student->class_id)
            ->where('sm_assign_subjects.section_id', '=', @$student->section_id)
            ->where('sm_assign_subjects.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->where('sm_assign_subjects.school_id',$school_id)->get();
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $data = [];
            $data['student_subjects'] = $assignSubjects->toArray();
            return ApiBaseMethod::sendResponse($data, null);
    ...
    public function studentExamScheduleApi(Request $request, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            // $assign_subjects = SmAssignSubject::where('class_id', $student_detail->class_id)->where('section_id', $student_detail->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            ...
            $exam_schedule = DB::table('sm_exam_schedules')
                ...
                ->where('sm_exam_schedules.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_studentExamScheduleApi(Request $request,$school_id, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $exam_schedule = DB::table('sm_exam_schedules')
                ...
                ->where('sm_exam_schedules.section_id', '=', @$student_detail->section_id)
                ->where('sm_exam_schedules.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->
    ...
    public function studentTimelineApi(Request $request, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $timelines = DB::table('sm_student_timelines')
                ...
                ->where('sm_student_timelines.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function saas_studentTimelineApi(Request $request,$school_id, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $timelines = DB::table('sm_student_timelines')
                ...
                ->where('sm_student_timelines.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->
