            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($role))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'rolepermission/role-update',
                        'method' => 'POST']) }}
                        @else
                        @if(in_array(418, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'rolepermission/role-store', 'method'
                        => 'POST']) }}
                        @endif
                        @endif
                        <div class="white-box">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                @if(in_array(419, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                    <a class="dropdown-item" href="{{url('rolepermission/role-edit', [@$role->id])}}">@lang('lang.edit')</a>
                                                @endif
                                                @if(in_array(420, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                    <a class="dropdown-item deleteRole" data-toggle="modal" href="#" data-id="{{@$role->id}}" data-target="#deleteRole">@lang('lang.delete')</a>
                                               @endif
                                            </div>
                                            @if(@$role->id != 1)
                                                @if(in_array(541, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                    <a href="{{url('rolepermission/assign-permission', [@$role->id])}}" class=""   >
