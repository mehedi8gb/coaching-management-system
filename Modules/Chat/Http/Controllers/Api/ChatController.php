...
class ChatController extends Controller
{
    ...
    public function index($id = null, $notification_id = null)
    {
        try {
            ...
            return response()->json(compact('users', 'activeUser', 'messages', 'groups'));
...
//            'message' => 'required',
    ...
    public function show($id)
    {
        ...
        return response()->json(compact('users', 'activeUser', 'messages'));
    }
    ...
    public function files($type, $id)
    {
        ...
        return response()->json(compact('groups', 'users', 'messages', 'name', 'type', 'group'));
    }
...
//            'message' => 'required',
    ...
    public function new()
    {
        $users = $this->invitationService->getAllConnectedUsers();
        $groups = $this->groupService->getAllGroup();
        return response()->json(compact('users', 'groups'));
    }
